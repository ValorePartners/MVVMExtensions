...
void native_to_managed_trampoline_5 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, id p1, void * p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [3];
	MonoObject *mthis;
...
BOOL native_to_managed_trampoline_15 (id self, SEL _cmd, MonoMethod **managed_method_ptr, void * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
BOOL native_to_managed_trampoline_18 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
void native_to_managed_trampoline_24 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, id p1, id p2, void * p3, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4, const char *r5)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [4];
	MonoObject *mthis;
...
void native_to_managed_trampoline_25 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, id p1, id p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [3];
	MonoObject *mthis;
...
@interface AppDelegate : NSObject<UIApplicationDelegate> {
	...
	-(void) application:(id)p0 didReceiveRemoteNotification:(id)p1 fetchCompletionHandler:(void *)p2;
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSData, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.AppDelegate, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "RegisteredForRemoteNotifications");
	}

	-(void) application:(id)p0 didReceiveRemoteNotification:(id)p1 fetchCompletionHandler:(void *)p2
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, p2, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSDictionary, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "System.Action`1[[UIKit.UIBackgroundFetchResult, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065]], mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.AppDelegate, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveRemoteNotification");
	}

	-(BOOL) conformsToProtocol:(void *)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.IntPtr, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "Foundation.NSObject, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "InvokeConformsToProtocol");
	}

	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.AppDelegate, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@interface MainView : UIViewController {
	...
	@property (nonatomic, assign) id btnErrorAnalytics;
	...
	-(id) btnErrorAnalytics;
	-(void) setBtnErrorAnalytics:(id)p0;
	-(id) btnInputDialog;
...
@implementation MainView { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.MainView, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_btnErrorAnalytics");
	}

	-(void) setBtnErrorAnalytics:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.MainView, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_btnErrorAnalytics");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.MainView, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.MainView, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewWillDisappear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.MainView, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}
...
@implementation TableDisplay { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.TableDisplay, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.TableDisplay, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewWillDisappear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.TableDisplay, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}
...
@interface MobileRef_MVVM_IOS_CustomSource : NSObject<UIScrollViewDelegate> {
	void *__monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
...
@implementation MobileRef_MVVM_IOS_CustomSource { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSIndexPath, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.CustomSource, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "RowSelected");
	}

	-(void) scrollViewDidScroll:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIScrollView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.CustomSource, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "Scrolled");
	}
...
@interface TwoWayBinding : UIViewController {
	...
	@property (nonatomic, assign) id lblAlt;
	@property (nonatomic, assign) id lblHello;
	@property (nonatomic, assign) id txtAlt;
	...
	-(id) lblAlt;
	-(void) setLblAlt:(id)p0;
	-(id) lblHello;
	-(void) setLblHello:(id)p0;
	-(id) txtAlt;
	-(void) setTxtAlt:(id)p0;
	-(id) txtHello;
...
@implementation TwoWayBinding { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.TwoWayBinding, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_lblAlt");
	}

	-(void) setLblAlt:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UILabel, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.TwoWayBinding, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_lblAlt");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.TwoWayBinding, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_txtAlt");
	}

	-(void) setTxtAlt:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.TwoWayBinding, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_txtAlt");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.TwoWayBinding, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.TwoWayBinding, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewWillDisappear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.TwoWayBinding, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}
...
@implementation NOSqlData { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, "MobileRef.MVVM.IOS.NOSqlData, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.NOSqlData, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewWillDisappear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "MobileRef.MVVM.IOS.NOSqlData, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}
...
@interface MobileRef_MVVM_IOS_TableSource_2 : NSObject<UIScrollViewDelegate> {
	void *__monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
...
@implementation MobileRef_MVVM_IOS_TableSource_2 { } 
	...
	-(NSInteger) tableView:(id)p0 numberOfRowsInSection:(NSInteger)p1
	{
		...
		return native_to_managed_trampoline_12 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "System.nint, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.TableSource`2, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "RowsInSection");
	}

	-(id) tableView:(id)p0 cellForRowAtIndexPath:(id)p1
	{
		MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_13 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSIndexPath, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.TableSource`2, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "GetCell");
	}

	-(void) tableView:(id)p0 didSelectRowAtIndexPath:(id)p1
	{
		MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSIndexPath, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MobileRef.MVVM.IOS.TableSource`2, MobileRefMVVMIOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "RowSelected");
	}

	-(BOOL) conformsToProtocol:(void *)p0
	{
		MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_15 (self, _cmd, &managed_method, p0, "System.IntPtr, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "Foundation.NSObject, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "InvokeConformsToProtocol");
	}
@end
...
@implementation __NSObject_Disposer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, "Foundation.NSObject+NSObject_Disposer, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", ".ctor");
	}
@end
...
@implementation UIKit_UIBarButtonItem_Callback { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, "UIKit.UIBarButtonItem+Callback, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", ".ctor");
	}
@end
...
@implementation UIKit_UIScrollView__UIScrollViewDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_18 (self, _cmd, &managed_method, p0, "UIKit.UIScrollView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "UIKit.UIScrollView+_UIScrollViewDelegate, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "ShouldScrollToTop");
	}
...
@implementation UIKit_UITextView__UITextViewDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_18 (self, _cmd, &managed_method, p0, "UIKit.UITextView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "UIKit.UITextView+_UITextViewDelegate, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "ShouldBeginEditing");
	}

	-(BOOL) textView:(id)p0 shouldChangeTextInRange:(NSRange)p1 replacementText:(NSString *)p2
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_22 (self, _cmd, &managed_method, p0, p1, p2, "UIKit.UITextView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSRange, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "System.String, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "UIKit.UITextView+_UITextViewDelegate, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "ShouldChangeText");
	}

	-(BOOL) textViewShouldEndEditing:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_18 (self, _cmd, &managed_method, p0, "UIKit.UITextView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "UIKit.UITextView+_UITextViewDelegate, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "ShouldEndEditing");
	}
...
@implementation MBProgressHUD_MTMBProgressHUD__MBProgressHUDDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, "MBProgressHUD.MTMBProgressHUD+_MBProgressHUDDelegate, MBProgressHUD, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@implementation ModernHttpClient_NativeMessageHandler_DataTaskDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_24 (self, _cmd, &managed_method, p0, p1, p2, p3, "Foundation.NSUrlSession, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSUrlSessionDataTask, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSUrlResponse, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "System.Action`1[[Foundation.NSUrlSessionResponseDisposition, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065]], mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "ModernHttpClient.NativeMessageHandler+DataTaskDelegate, ModernHttpClient, Version=2.2.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveResponse");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_24 (self, _cmd, &managed_method, p0, p1, p2, p3, "Foundation.NSUrlSession, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSUrlSessionTask, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSUrlAuthenticationChallenge, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "System.Action`2[[Foundation.NSUrlSessionAuthChallengeDisposition, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065],[Foundation.NSUrlCredential, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065]], mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "ModernHttpClient.NativeMessageHandler+DataTaskDelegate, ModernHttpClient, Version=2.2.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveChallenge");
	}
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [7].handle = [MobileRef_MVVM_IOS_CustomSource class];
	__xamarin_class_map [8].handle = [TwoWayBinding class];
	__xamarin_class_map [9].handle = objc_getClass ("UIView");
	__xamarin_class_map [10].handle = objc_getClass ("UITableViewCell");
	__xamarin_class_map [11].handle = [WeatherCell class];
	__xamarin_class_map [12].handle = [PersonCell class];
	__xamarin_class_map [13].handle = [NOSqlData class];
	__xamarin_class_map [14].handle = [MobileRef_MVVM_IOS_TableSource_2 class];
	...
	__xamarin_class_map [20].handle = objc_getClass ("NSHTTPCookie");
	__xamarin_class_map [21].handle = objc_getClass ("NSHTTPCookieStorage");
	__xamarin_class_map [22].handle = objc_getClass ("NSIndexPath");
	__xamarin_class_map [23].handle = objc_getClass ("NSStream");
	__xamarin_class_map [24].handle = objc_getClass ("NSInputStream");
	...
	__xamarin_class_map [32].handle = objc_getClass ("NSURLCredential");
	__xamarin_class_map [33].handle = objc_getClass ("NSURLProtectionSpace");
	...
	__xamarin_class_map [48].handle = objc_getClass ("UINib");
	...
	__xamarin_class_map [56].handle = objc_getClass ("NSCachedURLResponse");
	...
	__xamarin_class_map [61].handle = objc_getClass ("NSURLAuthenticationChallenge");
	__xamarin_class_map [62].handle = objc_getClass ("NSURLSession");
	__xamarin_class_map [63].handle = objc_getClass ("NSURLSessionTask");
	__xamarin_class_map [64].handle = objc_getClass ("NSURLSessionDataTask");
	__xamarin_class_map [65].handle = objc_getClass ("NSURLSessionConfiguration");
	__xamarin_class_map [66].handle = objc_getClass ("NSURLResponse");
	__xamarin_class_map [67].handle = objc_getClass ("NSOperationQueue");
	__xamarin_class_map [68].handle = objc_getClass ("NSHTTPURLResponse");
	...
	__xamarin_class_map [92].handle = objc_getClass ("UIKit_UITextView__UITextViewDelegate");
	__xamarin_class_map [93].handle = objc_getClass ("UITextView");
	__xamarin_class_map [94].handle = [MBRoundProgressView class];
	__xamarin_class_map [95].handle = [MBBarProgressView class];
	__xamarin_class_map [96].handle = [MBProgressHUD_MTMBProgressHUD__MBProgressHUDDelegate class];
	__xamarin_class_map [97].handle = [MBProgressHUD class];
	__xamarin_class_map [98].handle = [ModernHttpClient_NativeMessageHandler_DataTaskDelegate class];
	xamarin_setup_classmap (__xamarin_class_map, 99);
}
